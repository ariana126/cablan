...
const user = { id: 'user-1', name: 'Sina Ghadrdan', username: 'sina.q', role: Role.reporter };

describe('ConfirmDeleteUserDialog', () => {
  let close: ReturnType<typeof vi.fn>;
  let httpMock: HttpTestingController;
  let fixture: ReturnType<typeof TestBed.createComponent<ConfirmDeleteUserDialog>>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ConfirmDeleteUserDialog);
  ...
  it('closes with true once the deletion succeeds', async () => {
    ...
    httpMock
      .expectOne({ method: 'DELETE', url: '/api/users/user-1' })
