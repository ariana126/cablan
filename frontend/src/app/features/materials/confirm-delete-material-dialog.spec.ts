...
describe('ConfirmDeleteMaterialDialog', () => {
  let close: ReturnType<typeof vi.fn>;
  let httpMock: HttpTestingController;
  let fixture: ReturnType<typeof TestBed.createComponent<ConfirmDeleteMaterialDialog>>;
  ...
  beforeEach(async () => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        { provide: MAT_DIALOG_DATA, useValue: { material } },
      ],
    });

    fixture = TestBed.createComponent(ConfirmDeleteMaterialDialog);
  ...
  it('names the material being deleted', () => {
  ...
  it('closes with true once the deletion succeeds', async () => {
    ...
    httpMock
      .expectOne({ method: 'DELETE', url: '/api/materials/material-1' })
